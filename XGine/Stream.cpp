...
// Loading API
NxU8 FileStream::readByte() const
	{
	NxU8 b;
...
NxU16 FileStream::readWord() const
	{
	NxU16 w;
...
NxU32 FileStream::readDword() const
	{
	NxU32 d;
...
float FileStream::readFloat() const
	{
	NxReal f;
...
double FileStream::readDouble() const
	{
	NxF64 f;
...
void FileStream::readBuffer(void* buffer, NxU32 size)	const
	{
...
// Saving API
NxStream& FileStream::storeByte(NxU8 b)
	{
...
NxStream& FileStream::storeWord(NxU16 w)
	{
...
NxStream& FileStream::storeDword(NxU32 d)
	{
...
NxStream& FileStream::storeFloat(NxReal f)
	{
...
NxStream& FileStream::storeDouble(NxF64 f)
	{
...
NxStream& FileStream::storeBuffer(const void* buffer, NxU32 size)
	{
